...
sm = nn.Softmax(dim=1)  # Ensure softmax is applied along the correct dimension
...
class Model(nn.Module):
    def __init__(self, num_classes, latent_dim=2048, lstm_layers=1, hidden_dim=2048, bidirectional=False):
        ...
        self.dp = nn.Dropout(0.5)  # Increased dropout rate to reduce overfitting
    ...
    if request.method == "GET":
        ...
        try:
            ...
            for i in range(len(path_to_videos)):
                ...
                print(f"Prediction: {prediction[0]}, Output: {output}, Confidence: {confidence}")
